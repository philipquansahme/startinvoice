<?php
	...
	function sendAddedUser($to_name, $to_email, $password, $business_name){
		...
		$swap_var = array(
			...
			"{EMAIL_TITLE}" => "You've been registered! | Start Invoice",
			"{CUSTOM_URL}" => SITE_URL . "/index.php?email=".$to_email,
			"{PASSWORD}" => $password,
											...
											<tbody>
												<tr>
													<td style="border-bottom:1px solid #f6f6f6;">
														...
														<h2 style="margin-top:0px; color:#1E88E5; text-align: center;">You have been added to {BUSINESS_NAME} on Start Invoice</h2>
													</td>
												</tr>
												<tr>
